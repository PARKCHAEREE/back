...
CREATE TABLE IF NOT EXISTS plant_feature_logs (
  ...
  dust_coverage_ratio DOUBLE NULL,
  snow_coverage_ratio DOUBLE NULL,
  bird_dropping_count INT NULL,
  physical_damage_count INT NULL,
  max_defect_confidence DOUBLE NULL,
  cls_normal INT NULL,
  cls_dust INT NULL,
  cls_snow INT NULL,
  cls_bird INT NULL,
